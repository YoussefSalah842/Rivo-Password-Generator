...
namespace Rivo_Password_Generator
{
    ...
    {
        private Password_Manager passwordManagerForm;
        ...
        {
            Process.Start("https://techworld842.blogspot.com/p/privacy-policy.html");
        }

        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("https://techworld842.blogspot.com/p/usage-agreement.html");
        }
